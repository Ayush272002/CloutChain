      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="px-4 lg:px-6 h-16 flex items-center justify-between border-b border-purple-900/30 backdrop-blur-sm bg-black/50">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" className="bg-white text-black hover:bg-zinc-700 hover:bg-gradient-to-r hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 cursor-pointer">
              Login
            </Button>
