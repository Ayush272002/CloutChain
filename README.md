...
```bash
cd engine
git clone https://huggingface.co/Ayush272002/Cloutchain-models
mv Cloutchain-models model
```

`npm i; npm run dev` on both frontend and backend and to run the flask serevr run 
```bash
cd engine
cd flask
python3 server.py
